...
public class Constants {
	...
	public static float POINTS = 500;
	...
	public static final String[] MONSTERS = {"data/monsters/Type1.png", "data/monsters/Type2.png", "data/monsters/Type3.png", "data/monsters/Type4.png","data/monsters/Type5.png"};
}
